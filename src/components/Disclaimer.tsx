...
const Disclaimer: React.FC = () => {
    ...
    return (
        <div className="w-full flex justify-center items-center h-screen fixed top-0 left-0 backdrop-blur-sm z-50">
            <div className="bg-white p-6 w-3/4 shadow-md">
                <h1 className="text-4xl font-bold mb-4">{t('disclaimer.title')}</h1>
                <p className="text-xl mb-4">{t('disclaimer.text')}</p>
